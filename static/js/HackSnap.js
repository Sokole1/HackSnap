function checkSubjGroup(){
    ...
    switch(document.getElementById("groupDropDown").value){
        ...
        case "Group 3 - Individuals and Societies":
            document.getElementById("subjectDropDown").innerHTML="<option value='business'>Business</option><option value='itgs'>ITGS</option><option value='geography'>Geography</option><option value='history'>History</option>"
            break;
